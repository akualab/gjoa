...
// Copied from https://github.com/kless/gotool/tree/master/flagutil
// which is based on 'http://code.google.com/p/go/source/browse/src/cmd/go/main.go'
package main
...
// Parse parses both command and flag definitions from the argument list, which
// must include the command name.
